...
def check_for_attacks():
    ...
    # We proceed to detect WHAT they are doing even if banned, or stop early. 
    # Let's stop early to save resources and avoid spamming logs.
    ...
    # NEW: Known Hacking Tools (User-Agents)
    ...
    if detected_attack:
        ...
        try:
            ...
            # We ban for Medium, High, Critical
